...
export function Login(props) {
    ...
    return (
        <section id="login-section" style={!screenSize.small ? {width: sideBarOpen ? '85%' : '97%'} : {}}>
            <Helmet>
                <title>Chucktown Sound | Log In</title>
                <style>{bodyStyle}</style>
            </Helmet>

            <div id="login-wrapper-div" className="login-wrapper-div">
                <div id="login-content" className="login-content">
                    <LoginForm alert={alertHandler} />
                </div>
            </div>
        </section>
    )
